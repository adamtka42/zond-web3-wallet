...
jest.mock(
  "@/components/QrlWeb3Wallet/ScreenLoader/Wallet/Body/ChainConnectivity/NewChain/NewChain",
  () => () => <div>Mocked New Chain</div>,
);
jest.mock(
  "@/components/QrlWeb3Wallet/ScreenLoader/Wallet/Body/ChainConnectivity/ActiveChain/ActiveChain",
  () => () => <div>Mocked Active Chain</div>,
);
jest.mock(
  "@/components/QrlWeb3Wallet/ScreenLoader/Wallet/Body/ChainConnectivity/OtherChains/OtherChains",
